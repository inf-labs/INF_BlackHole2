...
static uint16_t EE_VerifyPageFullWriteVariable(uint16_t VirtAddress, int16_t Data);
static uint16_t EE_PageTransfer(uint16_t VirtAddress, int16_t Data);
...
/**
  ...
  *           - NO_VALID_PAGE: if no valid page was found.
	* 官方库函数读取的数据是uint16_t型，现改为int16_t型，以便支持正负数
  */
